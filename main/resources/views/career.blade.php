@extends('main')
@section('body')
    <header class="page-hero" style="background-image: url('https://dev3.eclecticoffice.com/assets/img/header/career_crop.png')">
    ...
    <section class="page-section career-page">
        <div class="container">
            ...
            <div class="career-gallery">
                <img src="https://dev3.eclecticoffice.com/assets/img/career.png" width="100%" />
            </div>
