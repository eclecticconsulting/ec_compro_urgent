...
@section('body')
            ...
            <div class="row align-items-center g-4">
                ...
                <div class="col-12 col-lg-5">
                    <div class="yonyou-logo">
                        <img src="https://dev3.eclecticoffice.com/assets/img/logo/gcp.png" alt="GCP" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="page-section yonyou-benefits-section">
        <img src="https://dev3.eclecticoffice.com/assets/img/gcp_benefit.png" alt="GCP Benefit" width="100%" />
        <div class="container">
